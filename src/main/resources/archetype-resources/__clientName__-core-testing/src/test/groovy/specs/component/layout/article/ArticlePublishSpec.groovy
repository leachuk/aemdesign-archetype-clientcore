...
class ArticlePublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component with Background"() {
        ...
        assert ${symbol_dollar}(selector).css("background-image").indexOf("/${symbol_dollar}{pathSite}/${symbol_dollar}{language}/${symbol_dollar}{pathPage}/_jcr_content/article/par/contentblock2/par/article/bgimage.img.png/0.png") > 0
