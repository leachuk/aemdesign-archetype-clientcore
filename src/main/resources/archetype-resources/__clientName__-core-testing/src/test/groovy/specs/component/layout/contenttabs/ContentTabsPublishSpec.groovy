...
class ContentTabsPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component with List of Children Pages"() {
        ...
        assert ${symbol_dollar}(selector + " ${symbol_pound}page1 .breadcrumb li")[3].text().trim() == "Content Tabs"

        when: "I select second tab"
        ${symbol_dollar}(selector + " .nav.nav-tabs").find("li:nth-child(2) a").click()
    ...
    def "Functionality of Component Variant: Render with List of Children Pages"() {
        ...
        assert ${symbol_dollar}(selector + " ${symbol_pound}page1 .breadcrumb li")[4].text().trim() == "Tab Page Content 1"
