...
class ImagePublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component Variant: Image Title and Description with Asset Metadata"() {
        ...
        assert ${symbol_dollar}("${symbol_dollar}{selector} figure div.description").text() == "Stitched Panorama" //"Asset Description"
    ...
    def "Functionality of Component Variant: Image Title and Description with Adaptive Image"() {
        ...
        and: "Has description line embedded in Asset"
        assert ${symbol_dollar}("${symbol_dollar}{selector} figure div.description").text() == "Stitched Panorama"
    ...
    def "Functionality of Component Variant: Default with Generated Image"() {
        ...
        and: "Should have sample content"
        assert ${symbol_dollar}("${symbol_dollar}{selector} img").attr("src").contains("/contentblock20/par/image.img.png/")
        takeScreenshot(${symbol_dollar}(selectorContainer).firstElement(), "Should have sample content")
