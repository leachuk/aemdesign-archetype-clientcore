...
class ContentBlockPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component Variant: Section with Background"() {
        ...
        assert ${symbol_dollar}(selector).css("background-image").indexOf("/content/swinburne-showcase/en/component/layout/contentblock/_jcr_content/article/par/contentblock9/bgimage.img.png/0.png") > 0
    ...
    def "Functionality of Component Variant: Section with Background Video"() {
        ...
        and: 'Section should have a background image'
        assert ${symbol_dollar}(selector).css("background-image").indexOf("/content/swinburne-showcase/en/component/layout/contentblock/_jcr_content/article/par/contentblock10/bgimage.img.png/0.png") == -1

        and: 'Section should have video tag with video rendition'
        assert ${symbol_dollar}("${symbol_dollar}{selector} source").firstElement().getAttribute("src").contains("/content/dam/swinburne-showcase/en/multimedia/video/Clouds.mov/jcr:content/renditions/cq5dam.video.flv.320.240.flv")
