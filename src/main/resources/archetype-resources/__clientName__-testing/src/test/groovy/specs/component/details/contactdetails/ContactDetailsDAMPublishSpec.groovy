...
class ContactDetailsDAMPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component variant Default using DAM Asset as Page Image"() {
        ...
        assert ${symbol_dollar}("${symbol_dollar}{selector} img").attr("src").contains("/content/dam/swinburne-showcase/en/common/images/abstract.jpg/_jcr_content/renditions/cq5dam.thumbnail.319.319.png")
