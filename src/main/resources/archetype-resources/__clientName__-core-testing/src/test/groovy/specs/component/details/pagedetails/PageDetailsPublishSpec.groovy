...
class PageDetailsPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component with Background and Included Components"() {
        ...
        assert ${symbol_dollar}(selector).css("background-image").indexOf("/content/dam/${clientName}-core-showcase/en/components/media/image/city2.jpg") > 0
        ...
        assert ${symbol_dollar}("${symbol_dollar}{selector} ol.breadcrumb li").first().text().trim() == "${clientName}-core Showcase"
    ...
    def "Functionality of Component with Background and Inherited Toolbar"() {
        ...
        and: "Has Toolbar has sample content"
        assert ${symbol_dollar}("${symbol_dollar}{selector} nav.breadcrumb li").first().text().trim() == "${clientName}-core Showcase"
