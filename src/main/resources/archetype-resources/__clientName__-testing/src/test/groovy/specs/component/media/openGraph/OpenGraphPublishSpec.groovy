...
class OpenGraphPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Open Graph"() {
        ...
        assert ${symbol_dollar}("${symbol_dollar}selector [property='og:url']").attr("content").contains("/content/swinburne-showcase/en/component/media/open-graph")
        ...
        assert ${symbol_dollar}("${symbol_dollar}selector [property='og:image']").attr("content").contains("/content/dam/swinburne-showcase/en/common/knowing.png")
