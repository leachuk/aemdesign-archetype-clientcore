...
//    }
    ...
    def execDialog(String path, String action) {
        //CQ.utils.WCM.getDialogs()["editdialog-/content/${clientName}-core-showcase/en/component/layout/contentblocklock/jcr:content/article/par/contentblocklock1"].find("name","permissionCheckTabAccessCheck")
        throw new Error("not implemented")
