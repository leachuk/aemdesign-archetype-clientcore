...
//         assert ${symbol_dollar}("${symbol_dollar}{selector} video").attr("currentTime") != "0"
        takeScreenshot(${symbol_dollar}(selectorContainer).firstElement(), "Should have sample content playing")
