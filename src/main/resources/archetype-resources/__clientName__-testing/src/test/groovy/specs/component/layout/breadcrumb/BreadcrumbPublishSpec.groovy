...
class BreadcrumbPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component"() {
        ...
        ${symbol_dollar}(selector + " a[href='/content/swinburne-showcase/en/component.html']", text: "Components")

        and: 'There should be a HREF value associated with Layout link'
        ${symbol_dollar}(selector + " a[href='/content/swinburne-showcase/en/component/layout.html']", text: "Layout")

        and: 'There should be a HREF value associated with Breadcrumb link'
        ${symbol_dollar}(selector + " li.active a[href='/content/swinburne-showcase/en/component/layout/breadcrumb.html']", text: "Breadcrumb")
    ...
    def "Functionality of Breadcrumb with light style"() {
        ...
        assert ${symbol_dollar}("${symbol_dollar}selector li:nth-child(1)").text().trim() == "Swinburne Showcase"
