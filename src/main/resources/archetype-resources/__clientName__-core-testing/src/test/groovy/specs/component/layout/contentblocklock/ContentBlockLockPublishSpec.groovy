...
class ContentBlockLockPublishSpec extends ComponentSpec {
    ...
    def "Functionality of Component Variant: Section with Background"() {
        ...
        assert ${symbol_dollar}(selector).css("background-image").indexOf("/content/${clientName}-core-showcase/en/component/layout/contentblocklock/_jcr_content/article/par/contentblocklock8/bgimage.img.png/0.png") > 0
