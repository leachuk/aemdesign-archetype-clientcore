...
class ExternalPublishSpec extends ComponentSpec {
    ...
    @Unroll("Functionality of Component Variant: Default with Parameters in ${symbol_pound}viewport.label")
    ...
    @Unroll("Functionality of Component Variant: Default without Parameters in ${symbol_pound}viewport.label")
